...
// NewPathResolver creates new Splitter instance.
func NewSplitter(pi *PathInfo, chunkCnt int, ctx context.Context) *Splitter {
    return &Splitter{PI: pi, ChunkCnt: chunkCnt, Ctx: ctx}
}
